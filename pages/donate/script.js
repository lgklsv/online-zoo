...
function removeActive() {
  ...
  allAmounts.forEach((el) =>
    el.classList.contains('progress-bar-amount-cash-active')
      ? el.classList.remove('progress-bar-amount-cash-active')
      : ''
  );

  Array.from(dotsContainer.children).forEach((dot) =>
    dot.firstElementChild.classList.contains('progress-bar-amount-dot-active')
      ? dot.firstElementChild.classList.remove('progress-bar-amount-dot-active')
      : ''
  );
}
